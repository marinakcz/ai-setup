...
const ICON_MAP: Record<string, string> = {
  ...
  VPS: "/icons/hetzner.svg",
  Vault: "/icons/tolaria.svg",
};
          ...
          <div className="max-w-[1408px] mx-auto px-6 w-full">
            <div className="text-center mb-12 md:mb-16">
              ...
              <p className="font-body font-light text-[clamp(0.875rem,1.1vw,1.125rem)] leading-[1.7] text-muted-foreground max-w-2xl mx-auto">
                Modulární systém AI agentů, paměti a nástrojů. Zadáte záměr,
                systém naplánuje postup, sestaví tým agentů a vytvoří funkční
                produkt. Weby, aplikace, prototypy, experimenty.
              </p>
              <div className="mt-4">
            ...
            <div className="max-w-2xl mx-auto space-y-0">
              ...
              <div className="p-6 rounded-t-2xl border-2 border-border bg-card/30 text-center hover:border-primary/30 transition-colors">
                ...
                <p className="font-mono text-xs text-muted-foreground mt-1">
                  Zadá brief. Schválí plán. Řídí směr.
                </p>
              </div>
              ...
              <div className="p-6 border-2 border-border bg-card/30 hover:border-primary/30 transition-colors">
                <p className="font-body font-semibold text-lg text-foreground text-center">
                  Projektový kontext
                </p>
                <p className="font-mono text-xs text-muted-foreground mt-1 text-center mb-4">
                  Agent negeneruje naslepo. Pracuje s kontextem projektu.
                </p>
                <div className="grid grid-cols-3 gap-3">
                  <div className="px-3 py-2 rounded-lg border border-border/50 text-center">
                    <p className="font-mono text-[11px] text-primary font-medium">
                      Technický
                    </p>
                    <p className="font-mono text-[10px] text-muted-foreground mt-0.5">
                      Pravidla, stack, vzory
                    </p>
                  </div>
                  <div className="px-3 py-2 rounded-lg border border-border/50 text-center">
                    <p className="font-mono text-[11px] text-primary font-medium">
              ...
              <div className="p-6 border-2 border-border bg-card/30 text-center hover:border-primary/30 transition-colors">
                ...
                <p className="font-mono text-xs text-muted-foreground mt-1">
                  Rozloží úkol. Vybere agenty. Koordinuje celý proces.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border-2 border-border bg-card/30 hover:border-primary/30 transition-colors">
                ...
                <div className="p-5 text-center">
                  ...
                  <p className="font-mono text-xs text-muted-foreground mt-1">
                    Co fungovalo, rozhodnutí, historie
                  </p>
                </div>
              </div>
              ...
              <div className="p-6 rounded-b-2xl border-2 border-border bg-card/30 text-center hover:border-primary/30 transition-colors">
                ...
                <p className="font-mono text-xs text-muted-foreground mt-1">
                  Build, test, deploy. Web, aplikace, prototyp.
                </p>
              </div>
              ...
              <div className="flex justify-center pt-5">
                <div className="px-6 py-3 rounded-xl border-2 border-dashed border-border/50 text-center">
                  <p className="font-mono text-xs text-muted-foreground">
                    ↻ zpětná smyčka · monitoring · učení · optimalizace
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-[1408px] mx-auto px-6">
            <div className="text-center mb-14">
              ...
              <p className="font-body font-light text-[clamp(0.875rem,1.1vw,1.125rem)] leading-[1.7] text-muted-foreground mt-3 max-w-xl mx-auto">
                Nejlepší nástroje, které dnes existují. Otevřené, flexibilní,
                prověřené.
              </p>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-3 max-w-4xl mx-auto">
              {[
                ...
                {
                  icon: "Gemini",
                  note: "Deep research, generování obrázků, video",
                },
                ...
                {
                  icon: "Automatizace",
                  note: "n8n — workflows, integrace, AI agenti",
                },
                ...
                {
                  icon: "SEO",
                  note: "Audit, schema, GEO, AI search optimalizace",
                },
                { icon: "Scraping", note: "Firecrawl" },
                { icon: "Poznámky", note: "Obsidian" },
                { icon: "Vault", note: "Tolaria — knowledge base, notes" },
                { icon: "Notifikace", note: "Telegram" },
                { icon: "VPS", note: "Hetzner — engine, Redis, PM2" },
              ].map((item, i) => (
                <div
                  key={i}
                  className="group relative flex items-center gap-2.5 px-4 py-2.5 rounded-xl border border-border hover:border-primary/30 transition-colors cursor-default"
                >
                  <img
                  ...
                  <span className="pointer-events-none absolute -top-8 left-1/2 -translate-x-1/2 z-50 px-3 py-1.5 rounded-lg bg-foreground text-background text-xs font-mono whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity hidden md:block">
                    {item.note}
                  </span>
                </div>
              ))}
              ...
              {[
                {
                  num: "01",
                  title: "Nezávislost",
                  desc: "Každou část jde vyměnit. AI model, hosting, databáze, coding assistant.",
                },
                {
                  num: "02",
                  title: "Transparentnost",
                  desc: "Každý krok zalogovaný a vysvětlitelný. Žádná černá skříňka.",
                },
                {
                  num: "03",
                  title: "Člověk rozhoduje",
                  desc: "Systém navrhuje a realizuje. Směr a finální slovo má člověk.",
                },
                {
                  num: "04",
                  title: "Přenositelný",
                  desc: "Celý systém na jiný stroj. Git, Docker, MCP konfigurace.",
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="p-6 rounded-xl border border-border hover:border-primary/30 transition-colors group"
                >
                  <span className="font-mono text-xs text-primary/50 group-hover:text-primary transition-colors">
                    {item.num}
                  </span>
                  <h3 className="font-body font-semibold text-foreground mt-3 mb-2 group-hover:text-primary transition-colors">
                    {item.title}
                  </h3>
