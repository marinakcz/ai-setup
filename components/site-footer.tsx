    ...
    <footer className="relative z-10 py-10 mt-auto">
      ...
      <div className="max-w-[1408px] mx-auto px-6 flex flex-col items-center gap-6">
        ...
        <nav className="flex flex-wrap justify-center items-center gap-y-3 font-mono text-xs text-muted-foreground">
          <Link href="/o-studiu" className="py-1 px-3 hover:text-foreground transition-colors">O studiu</Link>
          <span className="text-border leading-none">/</span>
          <Link href="/pod-kapotou" className="py-1 px-3 hover:text-foreground transition-colors">Pod kapotou</Link>
          <span className="text-border leading-none">/</span>
          <Link href="/poptavka" className="py-1 px-3 hover:text-foreground transition-colors">Spojme se</Link>
          <span className="text-border leading-none">/</span>
          <Link href="/ochrana-udaju" className="py-1 px-3 hover:text-foreground transition-colors"><span className="hidden sm:inline">Ochrana osobních údajů</span><span className="sm:hidden">Ochrana údajů</span></Link>
        </nav>
