    ...
    <div className="relative min-h-screen flex flex-col">
      <main className="relative z-10 max-w-[1408px] mx-auto px-6 pt-24 pb-16 md:pt-32 md:pb-24">
        ...
        <section className="mb-20 reveal-group" ref={authorRef}>
          <div className="flex flex-col items-center text-center reveal-item">
            <img src="/pavel.png" alt="Pavel Martinovský" className="w-24 h-24 rounded-full mb-5" />
            ...
            <a
              ...
              className="inline-flex items-center gap-2 font-mono text-xs text-muted-foreground hover:text-primary transition-colors mt-4"
            >
