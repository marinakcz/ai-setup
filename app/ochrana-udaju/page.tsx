    ...
    <div className="relative min-h-screen flex flex-col">
      <main className="relative z-10 max-w-[1408px] mx-auto px-6 pt-24 pb-16 md:pt-32 md:pb-24">
        ...
        <div className="max-w-2xl mx-auto space-y-10">
          <div>
            <h2 className="font-body font-semibold text-[clamp(1.125rem,1.4vw,1.5rem)] leading-snug text-foreground mb-2">Co sbíráme</h2>
          ...
          <div>
            <h2 className="font-body font-semibold text-[clamp(1.125rem,1.4vw,1.5rem)] leading-snug text-foreground mb-2">Když nás kontaktujete</h2>
            <p className="font-body font-light text-[clamp(0.875rem,1.1vw,1.125rem)] text-muted-foreground leading-[1.8]">
          ...
          <div>
            <h2 className="font-body font-semibold text-[clamp(1.125rem,1.4vw,1.5rem)] leading-snug text-foreground mb-2">Kam údaje putují</h2>
            <p className="font-body font-light text-[clamp(0.875rem,1.1vw,1.125rem)] text-muted-foreground leading-[1.8]">
          ...
          <div>
            ...
            <p className="font-body font-light text-[clamp(0.875rem,1.1vw,1.125rem)] text-muted-foreground leading-[1.8]">
              ...
              Kontakt: <a href="mailto:studio@levouzadni.cz" className="text-primary hover:underline">studio@levouzadni.cz</a>.
            </p>
          </div>

          <div>
            <h2 className="font-body font-semibold text-[clamp(1.125rem,1.4vw,1.5rem)] leading-snug text-foreground mb-2">Právní základ</h2>
            <p className="font-body font-light text-[clamp(0.875rem,1.1vw,1.125rem)] text-muted-foreground leading-[1.8]">
          ...
          <div>
            <h2 className="font-body font-semibold text-[clamp(1.125rem,1.4vw,1.5rem)] leading-snug text-foreground mb-2">Vaše práva</h2>
            <p className="font-body font-light text-[clamp(0.875rem,1.1vw,1.125rem)] text-muted-foreground leading-[1.8]">
          ...
          <div>
            <h2 className="font-body font-semibold text-[clamp(1.125rem,1.4vw,1.5rem)] leading-snug text-foreground mb-2">Doba uchovávání</h2>
            <p className="font-body font-light text-[clamp(0.875rem,1.1vw,1.125rem)] text-muted-foreground leading-[1.8]">
